        ...
        <div class="flex min-h-auto flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form action="/session" method="POST" class="space-y-6">
                    ...
                    <?php if (isset($errors['creds'])): ?>
                        <p class="text-red-500 text-s italic mt-2"><?= $errors['creds'] ?></p>
                    <?php endif; ?>
                </form>
            </div>
        </div>
